...
class GL2JNIView extends GLSurfaceView {
	private static String TAG = "Origami";
...
//
//		float x = event.getX();
//		float y = MainActivity.screenHeight - event.getY();
//
//		switch (event.getAction()) {
//		case MotionEvent.ACTION_DOWN:
//			lastX = x;
//			lastY = y;
//			ORESJNIWrapper.touchB(x, y);
//			return true;
//
//		case MotionEvent.ACTION_MOVE:
//			int dx = (int)(x - lastX);
//			int dy = (int)(y - lastY);
//			ORESJNIWrapper.touchM(x, y, dx, dy);
//			lastX = x;
//			lastY = y;
//			return true;
//
//		case MotionEvent.ACTION_UP:
//			ORESJNIWrapper.touchE(x, y);
//			return true;
//		}
//		return false;
//	}
	private void init(boolean translucent, int depth, int stencil) {
		...
		setRenderer(new RendererWrapper(a_context));
	}
